...
# Source : https://pastebin.com/ikTKaQ5V
##########

#######################################################################################################################################
#		Hello !
#
#	Before you start running the script, to avoid you wasting your time and my time.
#	I ask you to take the time to read these few instructions!
#
#	The script is functional on all versions of Windows 10.
#	THE SCRIPT HAS TO BE MODIFIED ACCORDING TO THE USE YOU MAKE OF YOUR PC, THINK A FEW SECONDS BEFORE APPLYING IT.
#	If the script generates an unwanted action or if you realize that later on you miss a service
#	you just have to adapt the script to your needs.
#	
#	If you delete Xbox for example, line 135 and you realize that your Forza or your Sea Of Thieves is no longer working
#	You'll see that:
#	"DisableXboxFeatures",          # "EnableXboxFeatures"
#
# 	To reinstall Xbox, just do the following :
#
#	"EnableXboxFeatures",      # "DisableXboxFeatures",
#
#	I just changed the meaning. And this is valid for ALL the changes made by this script.
#	Once you've made the change, save your version of the script and restart the execution.
#
#	Everything will work perfectly again!
#
#	Enjoy !
#
########################################################################################################################################

############  Arguments to copy into ISE before starting the script ################
...
$tweaks = @(
    ...
    "DisableWiFiSense",             # "EnableWiFiSense", # Please comment this line if you want to do connection sharing
    ...
    # "DisableAutoLogger",          # "EnableAutoLogger", # May cause instability.
    "DisableDiagTrack",             # "EnableDiagTrack",
    "DisableWAPPush",               # "EnableWAPPush",
 
    # Permissions / Firewall / Autorun et cie #
    # SetUACLow",                    # "SetUACHigh", # This option disables user action confirmations. Disabling it is fine, but may cause some problems with some apps.
    ...
    "DisableUpdateDriver",           # "EnableUpdateDriver",  # This line disables the Drivers part of WinUpdate (used to reinstall its drivers properly). This service can still be find in services.msc.
    ...
    "DisableFileDeleteConfirm",     # "EnableFileDeleteConfirm", ## This line will delete without confirmation the files you delete without going through the trashcan.
    ...
    # "SetVisualFXPerformance",     # "SetVisualFXAppearance",  ## This line is used to change the whole visual of the Windows desktop (Reduce the taskbar).
	############ I disable it for you to avoid having all those who read not come and take my head on their little taskbar but if you read this, remove the # in front of the line 122 <3 #
    # "DisableThumbnails",          # "EnableThumbnails",
    "DisableThumbsDB",              # "EnableThumbsDB",
    #"RemoveENKeyboard",            # "AddENKeyboard",	## This line will remove the English keyboard from your PC. Replace the "EN" with the abbreviation of the language you are concerned with.
    ...
    "UninstallWindowsStore",        # "InstallWindowsStore", # This line deletes the Windows Store. To be reinstalled if you play Xbox Games.
    "DisableXboxFeatures",          # "EnableXboxFeatures", # Here we disable ALL Xbox, if you play games that need it, add a #, if you have deleted it, change the order.
...
# If you want to install an application, you just have to remove the #
## Warning -> If you modify the list by deleting a #, be careful that the last application in the list does not have a comma after it! ##
### Check the current script syntax to be sure ###
$niniteapps = @(
    ".net4.7",
    # "7zip",
    # "adaware",
...
Function UninstallMsftBloat {
    Write-Host "Suppression des logiciels installes par defaults..."
...
Function InstallMsftBloat {
    Write-Host "Installation des applications windows par defaut"
...
function UninstallThirdPartyBloat {
    Write-Host "Suppression des applications commerciales ..."
...
Function UninstallWindowsStore {
    Write-Host "Suppression du Windows Store..."
...
Function InstallWindowsStore {
    Write-Host "Installation du Windows Store..."
...
Function DisableXboxFeatures {
    Write-Host "Suppression de Xbox..."
...
Function DoNiniteInstall {
    ...
    Write-Host
    Read-Host "Press ENTER when Ninite finished is installations"
}
...
Write-Host
Write-Host
Write-Host " Optimisations W10 adapted by Metaljisawa"
Write-Host "(Version adapted from Disassembler)"
Write-Host "Take the time to adapt the script to your desires"
Write-Host
$confirmation = Read-Host "Once you are sure you have adapted the script to your needs, and only then, press o and ENTER!"
 
if ($confirmation -ne 'o') {
    Write-Host
    Write-Host "The launch is canceled"
    exit
}
